...
And on fitting $\tAmp_{2B}^{\text{Im}}$ as in
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{fitA2B.pdf}
\end{figure}
\begin{figure}[h!]
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         ...
         \includegraphics[width=\textwidth]{bsqfit_A2B_b_bnum_P1_-1_eta_8.pdf}
     \end{subfigure}
        \caption{Fit-Plot of $\tAmp^{\text{Im}}_{2B}=\tAmp^{\text{(b-odd)}}_{2B}$ for different Lorentz invariant $P\cdot b$ and $(b)^2$  ($P_{1} = -1$ , $\eta=8$)}
\end{figure}
